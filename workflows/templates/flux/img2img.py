"""FLUX image-to-image workflow template."""
...
_JSON = Path(__file__).resolve().parents[2] / "api" / "flux" / "flux-img2img.json"

description = "Transform an image using FLUX"
...
class Request(BaseModel):
    ...
    cfg: float = Field(default=1.0, ge=0, le=30)
...
def generate(params: Request) -> dict:
    ...
    return apply_params(
        ...
        denoise=params.denoise, image=params.image,
