"""FLUX upscale workflow template."""
...
_JSON = Path(__file__).resolve().parents[2] / "api" / "flux" / "flux-upscale.json"

description = "Upscale an image using FLUX with UltimateSDUpscale"
