"""SD 3.5 upscale workflow template."""
...
from comfyui_client.workflow import (
    load_workflow, set_input_image, set_sd3_prompt, set_upscale_params,
)

_JSON = Path(__file__).resolve().parents[2] / "api" / "sd35" / "sd35-upscale.json"

description = "Upscale an image using Stable Diffusion 3.5 with UltimateSDUpscale"
