"""SD 3.5 inpainting workflow template."""
...
from comfyui_client.workflow import (
    apply_params, load_workflow, set_inpaint_images, set_sd3_prompt,
)

_JSON = Path(__file__).resolve().parents[2] / "api" / "sd35" / "sd35-inpaint.json"

description = "Inpaint a masked region using Stable Diffusion 3.5"
