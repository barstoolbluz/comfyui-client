"""SD 1.5 image-to-image workflow template."""
...
_JSON = Path(__file__).resolve().parents[2] / "api" / "sd15" / "sd15-img2img.json"

description = "Transform an image using Stable Diffusion 1.5"
