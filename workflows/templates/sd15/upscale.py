"""SD 1.5 upscale workflow template."""
...
_JSON = Path(__file__).resolve().parents[2] / "api" / "sd15" / "sd15-upscale.json"

description = "Upscale an image using Stable Diffusion 1.5 with UltimateSDUpscale"
...
class Request(BaseModel):
    ...
    denoise: float = Field(default=0.3, ge=0, le=1)
